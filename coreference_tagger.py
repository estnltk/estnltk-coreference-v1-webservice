...
from coreference_api import initialize_coreference_components
from coreference_api import generate_features
from coreference_api import predict
...
class CoreferenceTagger(RelationTagger):
    ...
    def __init__(self, output_layer='coreference', resources_dir=None, stanza_models_dir=None, 
        ...
        resources_dir: str (default: None)
            ...
            and 'estonian_resources'. NB! This must be an absolute path.
